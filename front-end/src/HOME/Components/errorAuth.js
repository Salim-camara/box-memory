...
const ErrorAuth = () => {
    ...
    return(
        <div className="error__auth">
            ...
            <p className="error__auth--redirection">Vous allez être automatiquement redirigez vers la page de connexion, si ça ne fonctionne pas,<strong style= {{color: '#61DAFBFF'}} onClick={() => historique.push('/connexion')}><br />cliquez ici </strong></p>
